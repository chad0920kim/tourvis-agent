...
function generateDemoFeedback(limit, feedback_type) {
    const demoQuestions = [
        "체크카드는 결재가 안되나요?",
        "예약 확인할려구 전화했더니 그런 예약 없다고합니다",
        "항공권 결제 영수증과 취소 규정 영수증 받을 수 있을까요?",
        "항공권 취소 수수료 얼마인지 계산해주세요",
        "이름 띄어쓰기가 않되는데 어떻게 해야 하는지",
        "바우처 발행이 된건가요",
        "만2세가 안되는데 좌석을 위해서 소아 요금을 지불하려고하는데 결제가 안됨",
        "5000원 결제가 두건이 되어있는데 확인하고싶어",
        "마일리지 적립",
        "항공권 인보이스를 출력하고 싶습니다",
        "여권정보가 틀렸을 경우는 어떻게 되나요?",
        "호텔 레이트 체크아웃 가능할까요?",
        "체크인",
        "e-ticket 출력 방법",
        "발권수수료",
    ...
    const demoAnswers = [
        "체크카드 결제에 대한 구체적인 정보는 제공되지 않았습니다. 일반적으로 체크카드는 신용카드와 달리 즉시 결제가 이루어지며, 무이자 할부 혜택은 적용되지 않을 수 있습니다.",
